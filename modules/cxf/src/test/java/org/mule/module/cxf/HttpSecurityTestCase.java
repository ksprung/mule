...
public class HttpSecurityTestCase extends AbstractServiceAndFlowTestCase
{
    ...
    private static final String HTTP_SECURITY_NEWHTTP_CONF_FLOW_XML = "http-security-newhttp-conf-flow.xml";
    ...
    {
        assumeThat(configResources, is(not(equalTo(HTTP_SECURITY_NEWHTTP_CONF_FLOW_XML))));
